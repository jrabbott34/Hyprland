...
hl.bind("XF86AudioMicMute",     hl.dsp.exec_cmd("~/.config/hypr/scripts/volume.sh micmute"), { locked = true })
...
-- Float these apps
hl.window_rule({ name = "float-pavucontrol",  match = { class = "org.pulseaudio.pavucontrol" }, float = true, center = true, size = "700 500" })
